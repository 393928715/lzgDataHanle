...
#         mysqldb.update(self.delete_day_sql)
   ...
   #3层目录结构来读取所有股票的数据，目前先测试录入2015-01 到2017-04的数据
    ...
    def getAllStockPath(slef,stockpath):
       ...
       pwd  = os.path.dirname(os.getcwdu())

       onelayerpath  = pwd+stockpath
       
#       onelayerpath = onelayerpath.replace("DataHanle","")
#           
       # 年目录
       dironelist = os.listdir(onelayerpath)
       ...
       for dlist_one in dironelist :
           ...
           #月目录
           dirtwolist = os.listdir(twolayerpath)
...
#        engine = create_engine('mysql://root:lzg000@127.0.0.1/stocksystem?charset=utf8')
        ...
        sample_path = os.path.dirname(os.getcwdu())+self.sdate_samplepath +"sample.csv"
        
        sampledf =  pd.read_csv(sample_path)
               ...
               try:           
                   ...
                   if fpos!=-1 or fposc!=-1:
                      ...
                      if len(lflist)>=2:
                         ...
                         bkname_1min  = os.path.dirname(os.getcwdu()) + self.sdata_historypath + tbkclass_1min
...
if '__main__'==__name__:  
    ...
    stockhandle.StockTickHandle(dirlist,engine)
